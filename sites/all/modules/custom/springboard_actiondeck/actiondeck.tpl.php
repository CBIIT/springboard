  ...
  <div class="row">
    ...
    <div class="col-md-7">
      <div class="deck-share">
        ...
        <!-- Print Action Deck -->
        <a href="" onclick="var w = window.open('/springboard/print-action-deck/<?php print $eid; ?>','_blank'); w.print();" target="_top" class="btn-blue"><div class="print-icon"></div>PRINT</a>
	  ...
	  <?php if (!empty($symptom_cards)): ?>
        ...
        <?php foreach($symptom_cards as $card) : ?>
        	...
        	<div id="<?php print preg_replace('/[^A-Za-z0-9\-]/', '', str_replace(' ', '-', $card['title'])); ?>-card" role="treeitem" class="collapse card-box-container">
                <?php $card_load = node_view(node_load($card['nid'])); ?>
            	<?php print render($card_load);?>
          	</div>
        <?php endforeach; ?>
      <?php endif; ?>
