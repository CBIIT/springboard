...
$overall = (int)$submission->data[2][0] + (int)$submission->data[3][0] + (int)$submission->data[4][0] + (int)$submission->data[5][0];
//print '<pre>';print_r(gettype($overall));print '</pre>';
?>
...
<div class="webform-results">
  ...
  <div class="results">
	  <?php if ($overall <= "4") {
		print '<h3>This score shows your stress levels are low.</h3> <p>There may be some things that occasionally upset you or are difficult to deal with, but overall you are handling your stress.</p> <p>Everybody’s stressors are different. Certain events—even happy ones—can trigger stress. If you’re concerned about stress in your life, you might want to talk to a friend or family member about how you’re feeling or <a href="/springboard/stress-mood/practice-mindfulness">learn coping skills</a> for stressful times. </p>';
	  }
      elseif ($overall>= 5 && $overall<= 10) {
          print '<h3>This score shows your stress levels are moderate.</h3> <p>The stress you’re having probably isn’t overwhelming, but it might be causing problems in your daily life. These problems may be making you feel down, anxious, or nervous. </p><p>If you’re concerned about stress in your life, you might want to talk to a friend or family member about how you’re feeling.</p> <h3>Manage Your Stress</h3> <p>It’s important to find healthy ways to reduce stress and take care of yourself. There are many ways to relax your mind and body to help you <a href="/springboard/stress-mood/practice-mindfulness">cope with stress</a>. </p>';
      }
      elseif ($overall>= 11) {
          print '<h3>This score shows your stress levels are high.</h3> <p>You’ve got a lot going on right now. Whether the problems and stressors are at home, at work, or in your social circle, you’re probably feeling overwhelmed.</p> <h3>Take Stress Seriously</h3> <p>Stress can affect your body, your thoughts, and your feelings. Long-term stress can lead to health problems. Understanding the causes of your stress is an important first step in dealing with it. If you’re feeling high levels of stress, try talking to a friend, family member, or your doctor. And find <a href="/springboard/stress-mood/practice-mindfulness">ways to reduce stress</a> and take care of yourself.</p>';
      }
	  ?>
  </div> <!-- close results -->
  </div> <!-- close column -->
